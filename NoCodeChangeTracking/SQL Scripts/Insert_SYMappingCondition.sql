...
CREATE OR ALTER TRIGGER Insert_SYMappingCondition
   ON SYMappingCondition
   AFTER INSERT
AS 
BEGIN
	...
	SELECT CompanyID, MappingID, LineNbr FROM inserted
