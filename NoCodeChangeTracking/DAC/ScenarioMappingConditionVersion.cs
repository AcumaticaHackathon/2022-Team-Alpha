...
{
    /// <summary>
    /// ScenarioMappingCondition change object version instance
    /// </summary>
    [Serializable]
    [PXCacheName("ScenarioMappingConditionVersion")]
    public class ScenarioMappingConditionVersion : AKChangeObjectVersion
    {
        #region ObjectName
